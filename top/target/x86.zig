...
pub const cpu = struct {
    pub const alderlake: Target.Cpu.Model = .{ .name = "alderlake", .llvm_name = "alderlake", .features = .{ .ints = .{ 1324369370633207984, 8251535946223622845, 15497953280, 0, 0 } } };
    pub const amdfam10: Target.Cpu.Model = .{ .name = "amdfam10", .llvm_name = "amdfam10", .features = .{ .ints = .{ 19791209299992, 108095328917391362, 285220872, 0, 0 } } };
    pub const athlon: Target.Cpu.Model = .{ .name = "athlon", .llvm_name = "athlon", .features = .{ .ints = .{ 37383395344392, 4294967296, 285212712, 0, 0 } } };
    pub const athlon64: Target.Cpu.Model = .{ .name = "athlon64", .llvm_name = "athlon64", .features = .{ .ints = .{ 37383395344408, 72057598332897282, 285213224, 0, 0 } } };
    pub const athlon64_sse3: Target.Cpu.Model = .{ .name = "athlon64_sse3", .llvm_name = "athlon64-sse3", .features = .{ .ints = .{ 19791209299992, 72057598332897282, 285213736, 0, 0 } } };
    pub const athlon_4: Target.Cpu.Model = .{ .name = "athlon_4", .llvm_name = "athlon-4", .features = .{ .ints = .{ 37383395344392, 4294969344, 285212968, 0, 0 } } };
    pub const athlon_fx: Target.Cpu.Model = .{ .name = "athlon_fx", .llvm_name = "athlon-fx", .features = .{ .ints = .{ 37383395344408, 72057598332897282, 285213224, 0, 0 } } };
    pub const athlon_mp: Target.Cpu.Model = .{ .name = "athlon_mp", .llvm_name = "athlon-mp", .features = .{ .ints = .{ 37383395344392, 4294969344, 285212968, 0, 0 } } };
    pub const athlon_tbird: Target.Cpu.Model = .{ .name = "athlon_tbird", .llvm_name = "athlon-tbird", .features = .{ .ints = .{ 37383395344392, 4294967296, 285212712, 0, 0 } } };
    pub const athlon_xp: Target.Cpu.Model = .{ .name = "athlon_xp", .llvm_name = "athlon-xp", .features = .{ .ints = .{ 37383395344392, 4294969344, 285212968, 0, 0 } } };
    pub const atom: Target.Cpu.Model = .{ .name = "atom", .llvm_name = "atom", .features = .{ .ints = .{ 19791209299984, 36028810309863424, 285245488, 0, 0 } } };
    pub const barcelona: Target.Cpu.Model = .{ .name = "barcelona", .llvm_name = "barcelona", .features = .{ .ints = .{ 19791209299992, 108095328917391362, 285220872, 0, 0 } } };
    pub const bdver1: Target.Cpu.Model = .{ .name = "bdver1", .llvm_name = "bdver1", .features = .{ .ints = .{ 72086250059726928, 108095346248255490, 1895825416, 0, 0 } } };
    pub const bdver2: Target.Cpu.Model = .{ .name = "bdver2", .llvm_name = "bdver2", .features = .{ .ints = .{ 9872200531374506064, 108095346248255618, 1895956488, 0, 0 } } };
    pub const bdver3: Target.Cpu.Model = .{ .name = "bdver3", .llvm_name = "bdver3", .features = .{ .ints = .{ 9872200531374506064, 108095346248256130, 5117181960, 0, 0 } } };
    pub const bdver4: Target.Cpu.Model = .{ .name = "bdver4", .llvm_name = "bdver4", .features = .{ .ints = .{ 9872200565734252624, 108376823640885890, 5117181960, 0, 0 } } };
    pub const bonnell: Target.Cpu.Model = .{ .name = "bonnell", .llvm_name = "bonnell", .features = .{ .ints = .{ 19791209299984, 36028810309863424, 285245488, 0, 0 } } };
    pub const broadwell: Target.Cpu.Model = .{ .name = "broadwell", .llvm_name = "broadwell", .features = .{ .ints = .{ 163706337799184560, 4648568195887008413, 4580179968, 0, 0 } } };
    pub const btver1: Target.Cpu.Model = .{ .name = "btver1", .llvm_name = "btver1", .features = .{ .ints = .{ 144134979285155856, 108095329051609154, 285253640, 0, 0 } } };
    pub const btver2: Target.Cpu.Model = .{ .name = "btver2", .llvm_name = "btver2", .features = .{ .ints = .{ 16861787084334039120, 108095346499913794, 4563410952, 0, 0 } } };
    pub const c3: Target.Cpu.Model = .{ .name = "c3", .llvm_name = "c3", .features = .{ .ints = .{ 4, 0, 285212704, 0, 0 } } };
    pub const c3_2: Target.Cpu.Model = .{ .name = "c3_2", .llvm_name = "c3-2", .features = .{ .ints = .{ 37383395344384, 134219776, 285212960, 0, 0 } } };
    pub const cannonlake: Target.Cpu.Model = .{ .name = "cannonlake", .llvm_name = "cannonlake", .features = .{ .ints = .{ 1297206343979368688, 5801490318969145917, 15317598208, 0, 0 } } };
    pub const cascadelake: Target.Cpu.Model = .{ .name = "cascadelake", .llvm_name = "cascadelake", .features = .{ .ints = .{ 1315221292357976304, 4648568814362298941, 15317598208, 0, 0 } } };
    pub const cooperlake: Target.Cpu.Model = .{ .name = "cooperlake", .llvm_name = "cooperlake", .features = .{ .ints = .{ 1315221292357927152, 4648568814362298941, 15317598208, 0, 0 } } };
    pub const core2: Target.Cpu.Model = .{ .name = "core2", .llvm_name = "core2", .features = .{ .ints = .{ 19791209299984, 36028801515259904, 285245472, 0, 0 } } };
    pub const core_avx2: Target.Cpu.Model = .{ .name = "core_avx2", .llvm_name = "core-avx2", .features = .{ .ints = .{ 163706337799184528, 4647996449840564893, 4580179968, 0, 0 } } };
    pub const core_avx_i: Target.Cpu.Model = .{ .name = "core_avx_i", .llvm_name = "core-avx-i", .features = .{ .ints = .{ 162439648864370704, 4647996449538312709, 4580180032, 0, 0 } } };
    pub const corei7: Target.Cpu.Model = .{ .name = "corei7", .llvm_name = "corei7", .features = .{ .ints = .{ 28587302322192, 36028938954213376, 285216768, 0, 0 } } };
    pub const corei7_avx: Target.Cpu.Model = .{ .name = "corei7_avx", .llvm_name = "corei7-avx", .features = .{ .ints = .{ 162158173887664144, 4647714974561601541, 4580180032, 0, 0 } } };
    pub const emeraldrapids: Target.Cpu.Model = .{ .name = "emeraldrapids", .llvm_name = "emeraldrapids", .features = .{ .ints = .{ 1349631750520882608, 3639850477552016957, 15431630848, 0, 0 } } };
    pub const generic: Target.Cpu.Model = .{ .name = "generic", .llvm_name = "generic", .features = .{ .ints = .{ 144150372447944720, 4611686018494627841, 285212672, 0, 0 } } };
    pub const geode: Target.Cpu.Model = .{ .name = "geode", .llvm_name = "geode", .features = .{ .ints = .{ 35184372088840, 0, 285212704, 0, 0 } } };
    pub const goldmont: Target.Cpu.Model = .{ .name = "goldmont", .llvm_name = "goldmont", .features = .{ .ints = .{ 9241415297544486992, 10413175718820186624, 15318650897, 0, 0 } } };
    pub const goldmont_plus: Target.Cpu.Model = .{ .name = "goldmont_plus", .llvm_name = "goldmont-plus", .features = .{ .ints = .{ 9223400899035005008, 10413263679750408704, 15318650897, 0, 0 } } };
    pub const grandridge: Target.Cpu.Model = .{ .name = "grandridge", .llvm_name = "grandridge", .features = .{ .ints = .{ 9223687526898729008, 12863257148955859584, 15499001873, 0, 0 } } };
    pub const graniterapids: Target.Cpu.Model = .{ .name = "graniterapids", .llvm_name = "graniterapids", .features = .{ .ints = .{ 1349631750520883120, 3639852676575272509, 15431630848, 0, 0 } } };
    pub const haswell: Target.Cpu.Model = .{ .name = "haswell", .llvm_name = "haswell", .features = .{ .ints = .{ 163706337799184528, 4647996449840564893, 4580179968, 0, 0 } } };
    pub const @"i386": Target.Cpu.Model = .{ .name = "i386", .llvm_name = "i386", .features = .{ .ints = .{ 0, 0, 285212704, 0, 0 } } };
    pub const @"i486": Target.Cpu.Model = .{ .name = "i486", .llvm_name = "i486", .features = .{ .ints = .{ 0, 0, 285212704, 0, 0 } } };
    pub const @"i586": Target.Cpu.Model = .{ .name = "i586", .llvm_name = "i586", .features = .{ .ints = .{ 35184372088832, 0, 285212704, 0, 0 } } };
    pub const @"i686": Target.Cpu.Model = .{ .name = "i686", .llvm_name = "i686", .features = .{ .ints = .{ 37383395344384, 0, 285212704, 0, 0 } } };
    pub const icelake_client: Target.Cpu.Model = .{ .name = "icelake_client", .llvm_name = "icelake-client", .features = .{ .ints = .{ 1297206344684044464, 1189874652106071613, 15330181120, 0, 0 } } };
    pub const icelake_server: Target.Cpu.Model = .{ .name = "icelake_server", .llvm_name = "icelake-server", .features = .{ .ints = .{ 1297206894439858352, 1189874686465809981, 15397289984, 0, 0 } } };
    pub const ivybridge: Target.Cpu.Model = .{ .name = "ivybridge", .llvm_name = "ivybridge", .features = .{ .ints = .{ 162439648864370704, 4647996449538312709, 4580180032, 0, 0 } } };
    pub const k6: Target.Cpu.Model = .{ .name = "k6", .llvm_name = "k6", .features = .{ .ints = .{ 35184372088832, 134217728, 285212704, 0, 0 } } };
    pub const k6_2: Target.Cpu.Model = .{ .name = "k6_2", .llvm_name = "k6-2", .features = .{ .ints = .{ 35184372088836, 0, 285212704, 0, 0 } } };
    pub const k6_3: Target.Cpu.Model = .{ .name = "k6_3", .llvm_name = "k6-3", .features = .{ .ints = .{ 35184372088836, 0, 285212704, 0, 0 } } };
    pub const k8: Target.Cpu.Model = .{ .name = "k8", .llvm_name = "k8", .features = .{ .ints = .{ 37383395344408, 72057598332897282, 285213224, 0, 0 } } };
    pub const k8_sse3: Target.Cpu.Model = .{ .name = "k8_sse3", .llvm_name = "k8-sse3", .features = .{ .ints = .{ 19791209299992, 72057598332897282, 285213736, 0, 0 } } };
    pub const knl: Target.Cpu.Model = .{ .name = "knl", .llvm_name = "knl", .features = .{ .ints = .{ 10376322180312596592, 13871945730232551936, 4563402770, 0, 0 } } };
    pub const knm: Target.Cpu.Model = .{ .name = "knm", .llvm_name = "knm", .features = .{ .ints = .{ 10376322180849467504, 13871945730232551936, 4563402770, 0, 0 } } };
    pub const lakemont: Target.Cpu.Model = .{ .name = "lakemont", .llvm_name = "lakemont", .features = .{ .ints = .{ 35184372088832, 0, 16777376, 0, 0 } } };
    pub const meteorlake: Target.Cpu.Model = .{ .name = "meteorlake", .llvm_name = "meteorlake", .features = .{ .ints = .{ 1324369370633207984, 8251535946223622845, 15497953280, 0, 0 } } };
    pub const nehalem: Target.Cpu.Model = .{ .name = "nehalem", .llvm_name = "nehalem", .features = .{ .ints = .{ 28587302322192, 36028938954213376, 285216768, 0, 0 } } };
    pub const nocona: Target.Cpu.Model = .{ .name = "nocona", .llvm_name = "nocona", .features = .{ .ints = .{ 19791209299984, 4429187072, 285213728, 0, 0 } } };
    pub const opteron: Target.Cpu.Model = .{ .name = "opteron", .llvm_name = "opteron", .features = .{ .ints = .{ 37383395344408, 72057598332897282, 285213224, 0, 0 } } };
    pub const opteron_sse3: Target.Cpu.Model = .{ .name = "opteron_sse3", .llvm_name = "opteron-sse3", .features = .{ .ints = .{ 19791209299992, 72057598332897282, 285213736, 0, 0 } } };
    pub const penryn: Target.Cpu.Model = .{ .name = "penryn", .llvm_name = "penryn", .features = .{ .ints = .{ 19791209299984, 36028801515259904, 285214752, 0, 0 } } };
    pub const pentium: Target.Cpu.Model = .{ .name = "pentium", .llvm_name = "pentium", .features = .{ .ints = .{ 35184372088832, 0, 285212704, 0, 0 } } };
    pub const pentium2: Target.Cpu.Model = .{ .name = "pentium2", .llvm_name = "pentium2", .features = .{ .ints = .{ 37383395344384, 4429187072, 285212704, 0, 0 } } };
    pub const pentium3: Target.Cpu.Model = .{ .name = "pentium3", .llvm_name = "pentium3", .features = .{ .ints = .{ 37383395344384, 4429187072, 285212960, 0, 0 } } };
    pub const pentium3m: Target.Cpu.Model = .{ .name = "pentium3m", .llvm_name = "pentium3m", .features = .{ .ints = .{ 37383395344384, 4429187072, 285212960, 0, 0 } } };
    pub const pentium4: Target.Cpu.Model = .{ .name = "pentium4", .llvm_name = "pentium4", .features = .{ .ints = .{ 37383395344384, 4429187072, 285213216, 0, 0 } } };
    pub const pentium4m: Target.Cpu.Model = .{ .name = "pentium4m", .llvm_name = "pentium4m", .features = .{ .ints = .{ 37383395344384, 4429187072, 285213216, 0, 0 } } };
    pub const pentium_m: Target.Cpu.Model = .{ .name = "pentium_m", .llvm_name = "pentium-m", .features = .{ .ints = .{ 37383395344384, 4429187072, 285213216, 0, 0 } } };
    pub const pentium_mmx: Target.Cpu.Model = .{ .name = "pentium_mmx", .llvm_name = "pentium-mmx", .features = .{ .ints = .{ 35184372088832, 134217728, 285212704, 0, 0 } } };
    pub const pentiumpro: Target.Cpu.Model = .{ .name = "pentiumpro", .llvm_name = "pentiumpro", .features = .{ .ints = .{ 37383395344384, 4294967296, 285212704, 0, 0 } } };
    pub const prescott: Target.Cpu.Model = .{ .name = "prescott", .llvm_name = "prescott", .features = .{ .ints = .{ 37383395344384, 4429187072, 285213728, 0, 0 } } };
    pub const raptorlake: Target.Cpu.Model = .{ .name = "raptorlake", .llvm_name = "raptorlake", .features = .{ .ints = .{ 1324369370633207984, 8251535946223622845, 15497953280, 0, 0 } } };
    pub const rocketlake: Target.Cpu.Model = .{ .name = "rocketlake", .llvm_name = "rocketlake", .features = .{ .ints = .{ 1297206344684044464, 1189874652106071613, 15330181120, 0, 0 } } };
    pub const sandybridge: Target.Cpu.Model = .{ .name = "sandybridge", .llvm_name = "sandybridge", .features = .{ .ints = .{ 162158173887664144, 4647714974561601541, 4580180032, 0, 0 } } };
    pub const sapphirerapids: Target.Cpu.Model = .{ .name = "sapphirerapids", .llvm_name = "sapphirerapids", .features = .{ .ints = .{ 1349631750520882608, 3639850477552016957, 15431630848, 0, 0 } } };
    pub const sierraforest: Target.Cpu.Model = .{ .name = "sierraforest", .llvm_name = "sierraforest", .features = .{ .ints = .{ 9223687526898729008, 12863221964583770752, 15499001873, 0, 0 } } };
    pub const silvermont: Target.Cpu.Model = .{ .name = "silvermont", .llvm_name = "silvermont", .features = .{ .ints = .{ 9529645398818291728, 9259691264260048896, 287313941, 0, 0 } } };
    pub const skx: Target.Cpu.Model = .{ .name = "skx", .llvm_name = "skx", .features = .{ .ints = .{ 1315221292223758576, 4648568814362298941, 15317598208, 0, 0 } } };
    pub const skylake: Target.Cpu.Model = .{ .name = "skylake", .llvm_name = "skylake", .features = .{ .ints = .{ 1315502217377095920, 4648568195887008445, 15317598208, 0, 0 } } };
    pub const skylake_avx512: Target.Cpu.Model = .{ .name = "skylake_avx512", .llvm_name = "skylake-avx512", .features = .{ .ints = .{ 1315221292223758576, 4648568814362298941, 15317598208, 0, 0 } } };
    pub const slm: Target.Cpu.Model = .{ .name = "slm", .llvm_name = "slm", .features = .{ .ints = .{ 9529645398818291728, 9259691264260048896, 287313941, 0, 0 } } };
    pub const tigerlake: Target.Cpu.Model = .{ .name = "tigerlake", .llvm_name = "tigerlake", .features = .{ .ints = .{ 1297206894708293808, 3495717662930378301, 15330181120, 0, 0 } } };
    pub const tremont: Target.Cpu.Model = .{ .name = "tremont", .llvm_name = "tremont", .features = .{ .ints = .{ 9223401448790818896, 10413263679750412800, 15318650897, 0, 0 } } };
    pub const westmere: Target.Cpu.Model = .{ .name = "westmere", .llvm_name = "westmere", .features = .{ .ints = .{ 28587302322192, 36028956134082560, 285216768, 0, 0 } } };
    pub const winchip2: Target.Cpu.Model = .{ .name = "winchip2", .llvm_name = "winchip2", .features = .{ .ints = .{ 4, 0, 285212704, 0, 0 } } };
    pub const winchip_c6: Target.Cpu.Model = .{ .name = "winchip_c6", .llvm_name = "winchip-c6", .features = .{ .ints = .{ 0, 134217728, 285212704, 0, 0 } } };
    pub const x86_64: Target.Cpu.Model = .{ .name = "x86_64", .llvm_name = "x86-64", .features = .{ .ints = .{ 37383395344400, 13835058059778590720, 285213184, 0, 0 } } };
    pub const x86_64_v2: Target.Cpu.Model = .{ .name = "x86_64_v2", .llvm_name = "x86-64-v2", .features = .{ .ints = .{ 162158173887660048, 4647714957381732357, 285216832, 0, 0 } } };
    pub const x86_64_v3: Target.Cpu.Model = .{ .name = "x86_64_v3", .llvm_name = "x86-64-v3", .features = .{ .ints = .{ 163565600310829200, 4647714957683722397, 1358954496, 0, 0 } } };
    pub const x86_64_v4: Target.Cpu.Model = .{ .name = "x86_64_v4", .llvm_name = "x86-64-v4", .features = .{ .ints = .{ 1315079730101682320, 4647715507439536189, 1358954496, 0, 0 } } };
    pub const yonah: Target.Cpu.Model = .{ .name = "yonah", .llvm_name = "yonah", .features = .{ .ints = .{ 37383395344384, 4429187072, 285213728, 0, 0 } } };
    pub const znver1: Target.Cpu.Model = .{ .name = "znver1", .llvm_name = "znver1", .features = .{ .ints = .{ 14555945552589103344, 1261861278184377011, 15317606408, 0, 0 } } };
    pub const znver2: Target.Cpu.Model = .{ .name = "znver2", .llvm_name = "znver2", .features = .{ .ints = .{ 14555946102344917232, 1262072384416910003, 15384715272, 0, 0 } } };
    pub const znver3: Target.Cpu.Model = .{ .name = "znver3", .llvm_name = "znver3", .features = .{ .ints = .{ 14555946102344917168, 1262072436023889587, 15397298184, 0, 0 } } };
    pub const znver4: Target.Cpu.Model = .{ .name = "znver4", .llvm_name = "znver4", .features = .{ .ints = .{ 14555664628161364144, 3567915445237587507, 15397298184, 0, 0 } } };
};
