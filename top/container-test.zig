...
pub fn main() !void {
    ...
    inline for (.{ u16, u32, u64 }) |child| {
        { // StructuredAutomaticView
            ...
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(offset, sentinel);
            ...
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(offset, sentinel);
        ...
        { // StructuredAutomaticStreamView
            ...
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(offset, sentinel);
            const ret_22: [read_count:sentinel]child = array.readCountWithSentinelBehind(read_count, sentinel);
            const ret_23: [:sentinel]const child = array.readManyWithSentinelBehind(offset, sentinel);
            const ret_24: [read_count:sentinel]child = array.readCountWithSentinelAhead(read_count, sentinel);
            const ret_25: [:sentinel]const child = array.readManyWithSentinelAhead(offset, sentinel);
            const ret_26: *child = array.referOneAt(offset);
            const ret_27: *[read_count]child = array.referCountAt(offset, read_count);
            const ret_28: []child = array.referManyAt(offset);
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(offset, sentinel);
            const ret_36: *[read_count:sentinel]child = array.referCountWithSentinelBehind(read_count, sentinel);
            const ret_37: [:sentinel]child = array.referManyWithSentinelBehind(offset, sentinel);
            const ret_38: void = array.overwriteOneAt(offset, value);
            const ret_39: void = array.overwriteCountAt(offset, write_count, values);
            const ret_40: void = array.overwriteManyAt(offset, &values);
            _ = ret_0;
        ...
        { // StructuredAutomaticStreamVector
            ...
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(offset, sentinel);
            const ret_20: [read_count:sentinel]child = array.readCountWithSentinelBack(read_count, sentinel);
            const ret_21: [:sentinel]const child = array.readManyWithSentinelBack(offset, sentinel);
            const ret_22: [read_count:sentinel]child = array.readCountWithSentinelBehind(read_count, sentinel);
            const ret_23: [:sentinel]const child = array.readManyWithSentinelBehind(offset, sentinel);
            const ret_24: [read_count:sentinel]child = array.readCountWithSentinelAhead(read_count, sentinel);
            const ret_25: [:sentinel]const child = array.readManyWithSentinelAhead(offset, sentinel);
            ...
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(offset, sentinel);
            const ret_34: *[read_count:sentinel]child = array.referCountWithSentinelBack(read_count, sentinel);
            const ret_35: [:sentinel]child = array.referManyWithSentinelBack(offset, sentinel);
            const ret_36: *[read_count:sentinel]child = array.referCountWithSentinelBehind(read_count, sentinel);
            const ret_37: [:sentinel]child = array.referManyWithSentinelBehind(offset, sentinel);
            const ret_38: void = array.overwriteOneAt(offset, value);
            const ret_39: void = array.overwriteCountAt(offset, write_count, values);
        ...
        { // UnstructuredStaticView
            ...
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(child, offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(child, offset, sentinel);
            ...
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(child, offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(child, offset, sentinel);
        ...
        { // UnstructuredStaticStreamVector
            ...
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(child, offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(child, offset, sentinel);
            const ret_20: [read_count:sentinel]child = array.readCountWithSentinelBack(child, read_count, sentinel);
            const ret_21: [:sentinel]const child = array.readManyWithSentinelBack(child, offset, sentinel);
            const ret_22: [read_count:sentinel]child = array.readCountWithSentinelBehind(child, read_count, sentinel);
            const ret_23: [:sentinel]const child = array.readManyWithSentinelBehind(child, offset, sentinel);
            const ret_24: [read_count:sentinel]child = array.readCountWithSentinelAhead(child, read_count, sentinel);
            const ret_25: [:sentinel]const child = array.readManyWithSentinelAhead(child, offset, sentinel);
            const ret_26: *child = array.referOneAt(child, offset);
            const ret_27: *[read_count]child = array.referCountAt(child, offset, read_count);
            const ret_28: []child = array.referManyAt(child, offset);
            ...
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(child, offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(child, offset, sentinel);
            const ret_34: *[read_count:sentinel]child = array.referCountWithSentinelBack(child, read_count, sentinel);
            const ret_35: [:sentinel]child = array.referManyWithSentinelBack(child, offset, sentinel);
            const ret_36: *[read_count:sentinel]child = array.referCountWithSentinelBehind(child, read_count, sentinel);
            const ret_37: [:sentinel]child = array.referManyWithSentinelBehind(child, offset, sentinel);
            const ret_38: void = array.overwriteOneAt(child, offset, value);
            const ret_39: void = array.overwriteCountAt(child, offset, write_count, values);
            const ret_40: void = array.overwriteManyAt(child, offset, &values);
        ...
        { // StructuredStreamHolder
            ...
            const ret_16: [read_count]child = array.readCountAhead(read_count);
            const ret_17: []const child = array.readManyAhead(offset);
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(allocator, offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(allocator, offset, sentinel);
            const ret_20: [read_count:sentinel]child = array.readCountWithSentinelBack(read_count, sentinel);
            const ret_21: [:sentinel]const child = array.readManyWithSentinelBack(offset, sentinel);
            const ret_22: [read_count:sentinel]child = array.readCountWithSentinelBehind(read_count, sentinel);
            const ret_23: [:sentinel]const child = array.readManyWithSentinelBehind(offset, sentinel);
            ...
            const ret_30: *[read_count]child = array.referCountBack(read_count);
            const ret_31: []child = array.referManyBack(offset);
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(allocator, offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(allocator, offset, sentinel);
            const ret_34: *[read_count:sentinel]child = array.referCountWithSentinelBack(read_count, sentinel);
            const ret_35: [:sentinel]child = array.referManyWithSentinelBack(offset, sentinel);
            const ret_36: *[read_count:sentinel]child = array.referCountWithSentinelBehind(read_count, sentinel);
            const ret_37: [:sentinel]child = array.referManyWithSentinelBehind(offset, sentinel);
        ...
        { // UnstructuredStreamHolder
            ...
            const ret_16: [read_count]child = array.readCountAhead(child, read_count);
            const ret_17: []const child = array.readManyAhead(child, offset);
            const ret_18: [read_count:sentinel]child = array.readCountWithSentinelAt(child, allocator, offset, read_count, sentinel);
            const ret_19: [:sentinel]const child = array.readManyWithSentinelAt(child, allocator, offset, sentinel);
            const ret_20: [read_count:sentinel]child = array.readCountWithSentinelBack(child, read_count, sentinel);
            const ret_21: [:sentinel]const child = array.readManyWithSentinelBack(child, offset, sentinel);
            const ret_22: [read_count:sentinel]child = array.readCountWithSentinelBehind(child, read_count, sentinel);
            const ret_23: [:sentinel]const child = array.readManyWithSentinelBehind(child, offset, sentinel);
            ...
            const ret_30: *[read_count]child = array.referCountBack(child, read_count);
            const ret_31: []child = array.referManyBack(child, offset);
            const ret_32: *[read_count:sentinel]child = array.referCountWithSentinelAt(child, allocator, offset, read_count, sentinel);
            const ret_33: [:sentinel]child = array.referManyWithSentinelAt(child, allocator, offset, sentinel);
            const ret_34: *[read_count:sentinel]child = array.referCountWithSentinelBack(child, read_count, sentinel);
            const ret_35: [:sentinel]child = array.referManyWithSentinelBack(child, offset, sentinel);
            const ret_36: *[read_count:sentinel]child = array.referCountWithSentinelBehind(child, read_count, sentinel);
            const ret_37: [:sentinel]child = array.referManyWithSentinelBehind(child, offset, sentinel);
