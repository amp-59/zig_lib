...
pub fn main() !void {
    ...
    inline for (.{ u16, u32, u64 }) |child| {
        { // StructuredAutomaticView
            ...
            const ret_27: [read_count]child = array.readCountAt(offset, read_count);
            const ret_28: *[read_count]child = array.referCountAt(offset, read_count);
            const ret_29: void = array.overwriteCountAt(offset, write_count, values);
            const ret_30: [read_count:sentinel]child = array.readCountWithSentinelAt(offset, read_count, sentinel);
            const ret_31: *[read_count:sentinel]child = array.referCountWithSentinelAt(offset, read_count, sentinel);
            ...
            const ret_35: [:sentinel]const child = array.readManyWithSentinelAt(offset, sentinel);
        ...
        { // StructuredAutomaticStreamView
            ...
            const ret_22: [:sentinel]const child = array.readManyWithSentinelBehind(offset, sentinel);
            const ret_23: [:sentinel]child = array.referManyWithSentinelBehind(offset, sentinel);
            const ret_24: child = array.readOneAt(offset);
            const ret_25: *child = array.referOneAt(offset);
            const ret_26: void = array.overwriteOneAt(offset, value);
            const ret_27: [read_count]child = array.readCountAt(offset, read_count);
            ...
            const ret_42: [:sentinel]const child = array.readManyWithSentinelAhead(offset, sentinel);
            _ = ret_11;
            _ = ret_12;
            _ = ret_13;
            _ = ret_14;
        ...
        { // StructuredAutomaticStreamVector
            ...
            const ret_56: [:sentinel]const child = array.readManyWithSentinelBack(offset, sentinel);
            const ret_57: [:sentinel]child = array.referManyWithSentinelBack(offset, sentinel);
        ...
        { // UnstructuredStaticView
            ...
            const ret_27: [read_count]child = array.readCountAt(child, offset, read_count);
            const ret_28: *[read_count]child = array.referCountAt(child, offset, read_count);
            const ret_29: void = array.overwriteCountAt(child, offset, write_count, values);
            const ret_30: [read_count:sentinel]child = array.readCountWithSentinelAt(child, offset, read_count, sentinel);
            const ret_31: *[read_count:sentinel]child = array.referCountWithSentinelAt(child, offset, read_count, sentinel);
            ...
            const ret_35: [:sentinel]const child = array.readManyWithSentinelAt(child, offset, sentinel);
        ...
        { // UnstructuredStaticStreamVector
            ...
            const ret_22: [:sentinel]const child = array.readManyWithSentinelBehind(child, offset, sentinel);
            const ret_23: [:sentinel]child = array.referManyWithSentinelBehind(child, offset, sentinel);
            const ret_24: child = array.readOneAt(child, offset);
            const ret_25: *child = array.referOneAt(child, offset);
            const ret_26: void = array.overwriteOneAt(child, offset, value);
            const ret_27: [read_count]child = array.readCountAt(child, offset, read_count);
            ...
            const ret_42: [:sentinel]const child = array.readManyWithSentinelAhead(child, offset, sentinel);
            ...
            const ret_56: [:sentinel]const child = array.readManyWithSentinelBack(child, offset, sentinel);
            const ret_57: [:sentinel]child = array.referManyWithSentinelBack(child, offset, sentinel);
        ...
        { // StructuredStreamHolder
            ...
            const ret_27: [read_count]child = array.readCountAt(allocator, offset, read_count);
            const ret_28: *[read_count]child = array.referCountAt(allocator, offset, read_count);
            const ret_29: void = array.overwriteCountAt(allocator, offset, write_count, values);
            const ret_30: [read_count:sentinel]child = array.readCountWithSentinelAt(allocator, offset, read_count, sentinel);
            const ret_31: *[read_count:sentinel]child = array.referCountWithSentinelAt(allocator, offset, read_count, sentinel);
            ...
            const ret_35: [:sentinel]const child = array.readManyWithSentinelAt(allocator, offset, sentinel);
        ...
        { // UnstructuredStreamHolder
            ...
            const ret_27: [read_count]child = array.readCountAt(child, allocator, offset, read_count);
            const ret_28: *[read_count]child = array.referCountAt(child, allocator, offset, read_count);
            const ret_29: void = array.overwriteCountAt(child, allocator, offset, write_count, values);
            const ret_30: [read_count:sentinel]child = array.readCountWithSentinelAt(child, allocator, offset, read_count, sentinel);
            const ret_31: *[read_count:sentinel]child = array.referCountWithSentinelAt(child, allocator, offset, read_count, sentinel);
            ...
            const ret_35: [:sentinel]const child = array.readManyWithSentinelAt(child, allocator, offset, sentinel);
