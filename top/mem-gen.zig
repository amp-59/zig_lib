...
pub fn main() void {
    ...
    writeHasFieldDeduction(&array, &reference.Construct);
    writeHasFieldDeduction(&array, &reference.Convert);
    writeHasFieldDeduction(&array, &reference.Translate);
    writeHasFieldDeduction(&array, &reference.Reconstruct);
    writeHasFieldDeduction(&array, &reference.Resize);
