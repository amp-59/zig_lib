...
pub const zl_trace: debug.Trace = .{
    ...
    .options = .{
        ...
        .tokens = .{
            ...
            .comment = "\x1b[2m",
            .syntax = if (true) &.{
                .{ .style = "\x1b\x5b\x39\x33\x6d", .tags = &.{.char_literal} },
                .{ .style = "\x1b[38;2;51;229;96m", .tags = parse.Token.Tag.strings },
                .{ .style = "\x1b[38;2;128;160;194m", .tags = parse.Token.Tag.bracket },
                .{ .style = "\x1b[38;2;198;120;221m", .tags = parse.Token.Tag.operator },
                .{ .style = "\x1b[38;2;233;86;120m", .tags = parse.Token.Tag.builtin_fn },
                .{ .style = "\x1b[38;2;54;208;224m", .tags = parse.Token.Tag.macro_keyword },
                .{ .style = "\x1b[38;2;193;173;247m", .tags = parse.Token.Tag.call_keyword },
                .{ .style = "\x1b[38;2;209;109;158m", .tags = parse.Token.Tag.container_keyword },
                .{ .style = "\x1b[38;2;255;255;255;1m", .tags = parse.Token.Tag.cond_keyword ++ parse.Token.Tag.qual_keyword },
                .{ .style = "\x1b[38;2;240;198;116m", .tags = parse.Token.Tag.goto_keyword ++ parse.Token.Tag.value_keyword },
                .{ .style = "\x1b[38;2;255;115;115m", .tags = &.{ .number_literal, .bool_literal, .null_literal } },
                .{ .style = "\x1b[1m", .tags = &.{.identifier_type_name} },
            } else &.{
...
pub const parse = struct {
    ...
    pub const Token = struct {
        ...
        pub const Tag = enum {
            ...
            pub const keyword: []const Token.Tag = &.{
                .keyword_addrspace,
                .keyword_align,
                .keyword_allowzero,
                .keyword_and,
