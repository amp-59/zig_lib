...
pub const P384 = struct {
    ...
    pub const fiat = @import("p384/p384_64.zig");
    ...
    pub const AffineCoordinates = struct {
        ...
        pub const identity_element: AffineCoordinates = .{
            .x = P384.identity_element.x,
            .y = P384.identity_element.y,
        };
    ...
    pub const identity_element: P384 = .{
        .x = Fe.zero,
        .y = Fe.one,
        .z = Fe.zero,
    };
    ...
    pub fn rejectIdentity(p: P384) errors.IdentityElementError!void {
        if (p.x.isZero()) {
            return error.IdentityElement;
        }
    }
    /// Create a point from affine coordinates after checking that they match the curve equation.
    pub fn fromAffineCoordinates(p: AffineCoordinates) errors.EncodingError!P384 {
        const x = p.x;
        const y = p.y;
        ...
        ret.z.cMov(P384.identity_element.z, is_identity);
        return ret;
    }
    /// Create a point from serialized affine coordinates.
    pub fn fromSerializedAffineCoordinates(xs: [48]u8, ys: [48]u8, endian: builtin.Endian) (errors.NonCanonicalError || errors.EncodingError)!P384 {
    ...
    pub fn fromSec1(s: []const u8) (errors.EncodingError || errors.NotSquareError || errors.NonCanonicalError)!P384 {
    ...
    pub fn random() P384 {
        ...
        return base_point.mul(n, .Little) catch builtin.zero(P384);
    }
    ...
    fn pcMul16(pc: *const [16]P384, s: [48]u8, comptime vartime: bool) errors.IdentityElementError!P384 {
        var q = P384.identity_element;
        var pos: usize = 380;
        while (true) : (pos -= 4) {
    ...
    /// This can be used for signature verification.
    pub fn mulDoubleBasePublic(p1: P384, s1_: [48]u8, p2: P384, s2_: [48]u8, endian: builtin.Endian) errors.IdentityElementError!P384 {
