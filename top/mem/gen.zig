...
pub fn writeImports(array: anytype, src: builtin.SourceLocation, imports: []const Import) void {
...
pub fn groupImplementations(allocator: anytype, comptime Detail: type, group_key: []const u16, group: []const Detail) []const Detail {
