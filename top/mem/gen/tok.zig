...
pub const low_alignment_impl_specifier_name: [:0]const u8 = fieldAccess(impl_spec_name, low_alignment_name);
...
pub const target_impl_ptr_name: [:0]const u8 = "t_impl_ptr";
...
pub const interface_source_allocated_byte_address_name: [:0]const u8 = "s.lb_addr";
pub const interface_target_allocated_byte_address_name: [:0]const u8 = "t.lb_addr";
pub const interface_source_unstreamed_byte_address_name: [:0]const u8 = "s.ss_addr";
pub const interface_target_unstreamed_byte_address_name: [:0]const u8 = "t.ss_addr";
pub const interface_source_aligned_byte_address_name: [:0]const u8 = "s.ab_addr";
pub const interface_target_aligned_byte_address_name: [:0]const u8 = "t.ab_addr";
pub const interface_source_undefined_byte_address_name: [:0]const u8 = "s.ub_addr";
pub const interface_target_undefined_byte_address_name: [:0]const u8 = "t.ub_addr";
pub const interface_source_unallocated_byte_address_name: [:0]const u8 = "s.up_addr";
pub const interface_target_unallocated_byte_address_name: [:0]const u8 = "t.up_addr";
pub const interface_source_single_approximation_counts_name: [:0]const u8 = "s.lb_counts";
pub const interface_source_double_approximation_counts_name: [:0]const u8 = "s.ub_counts";
pub const interface_target_single_approximation_counts_name: [:0]const u8 = "t.lb_counts";
pub const interface_target_double_approximation_counts_name: [:0]const u8 = "t.ub_counts";
pub const source_impl_type_param: [:0]const u8 = paramDecl(source_impl_type_name, type_type_name);
pub const target_impl_type_param: [:0]const u8 = paramDecl(target_impl_type_name, type_type_name);
pub const source_impl_param: [:0]const u8 = paramDecl(source_impl_name, source_impl_type_name);
pub const target_impl_param: [:0]const u8 = paramDecl(target_impl_name, target_impl_type_name);
pub const source_impl_ptr_param: [:0]const u8 = paramDecl(source_impl_ptr_name, pointerTo(source_impl_type_name));
pub const target_impl_ptr_param: [:0]const u8 = paramDecl(target_impl_ptr_name, pointerTo(target_impl_type_name));
...
pub const write_one_ptr_fn_name: [:0]const u8 = "writeOneInternal";
pub const write_count_ptr_fn_name: [:0]const u8 = "writeCountInternal";
pub const write_many_ptr_fn_name: [:0]const u8 = "writeManyInternal";
