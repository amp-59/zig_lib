...
fn mainStatic() void {
    ...
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "read", read[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "refer", refer[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "write", write[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "append", append[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "overwrite", overwrite[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "helper", helper[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "special", helper[0]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "value", is_value);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "one", one[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "read_one", read_one[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "refer_one", refer_one[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "count", count[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "read_count", read_count[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "refer_count", refer_count[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "many", many[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "read_many", read_many[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "refer_many", refer_many[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "sentinel", sentinel[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "at", at[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "defined", defined[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "@\"undefined\"", @"undefined"[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "streamed", streamed[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "unstreamed", unstreamed[1]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "relative", offset_defined[0] ++ offset_undefined[0] ++
        offset_streamed[0] ++ offset_unstreamed[0]);
    attr.Fn.static.writeKind(ctn_fn.Fn, &array, "offset", offset_defined[1] ++ offset_undefined[1] ++
