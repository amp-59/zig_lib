...
pub const child_array_ptr_type_name: [:0]const u8 = pointerTo(arrayType(child_type_name, read_count_name, null));
pub const child_array_ptr_with_sentinel_type_name: [:0]const u8 = pointerTo(arrayType(child_type_name, read_count_name, sentinel_name));
...
pub const child_array_type_name: [:0]const u8 = arrayType(child_type_name, read_count_name, null);
pub const child_array_with_sentinel_type_name: [:0]const u8 = arrayType(child_type_name, read_count_name, sentinel_name);
...
pub const read_many_name: [:0]const u8 = "read_" ++ count_name;
pub const read_many_param: [:0]const u8 = paramDecl(read_many_name, word_type_name);
...
pub const value_param: [:0]const u8 = value_name ++ ": " ++ child_type_name;
pub const count_values_name: [:0]const u8 = "values";
pub const count_values_param: [:0]const u8 = paramDecl(count_values_name, arrayType(child_type_name, write_count_name, null));
