...
pub const Argument = struct {
    ...
    pub fn writeValueSlicePtr(buf: [*]u8, arg: *const Argument) [*]u8 {
        var ptr: [*]u8 = zl.fmt.strcpyEqu(buf, arg.name);
        ptr[0..4].* = ".ptr".*;
        return ptr + 4;
    }
    pub fn writeValueSliceLen(buf: [*]u8, arg: *const Argument) [*]u8 {
        var ptr: [*]u8 = zl.fmt.strcpyEqu(buf, arg.name);
        ptr[0..4].* = ".len".*;
        return ptr + 4;
    }
};
pub const Type = zl.fmt.GenericTypeDescrFormat(.{
