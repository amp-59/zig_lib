...
pub const about = struct {
    ...
    fn aboutFdNotice(about_s: fmt.AboutSrc, fd: u64) void {
        ...
        ptr[0..3].* = "fd=".*;
        ptr = ptr + 3;
        ptr = ptr + fmt.ud64(fd).formatWriteBuf(ptr);
        ptr[0] = '\n';
    ...
    fn aboutFdMaxLenLenNotice(about_s: fmt.AboutSrc, fd: u64, max_len: u64, act_len: u64) void {
        ...
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        ptr = ptr + fmt.ud64(max_len).formatWriteBuf(ptr);
        ptr[0] = '/';
        ptr = ptr + 1;
        ud64.value = max_len;
        ptr = ptr + ud64.formatWriteBuf(ptr);
    ...
    fn aboutFdFdNotice(about_s: fmt.AboutSrc, fd1_s: anytype, fd2_s: anytype, fd1: u64, fd2: u64) void {
        ...
        ptr = ptr + fd1_s.len;
        ptr = ptr + fmt.ud64(fd1).formatWriteBuf(ptr);
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        ptr[0..fd2_s.len].* = fd2_s.*;
        ptr = ptr + fd2_s.len;
        ptr = ptr + fmt.ud64(fd2).formatWriteBuf(ptr);
        ptr[0] = '\n';
        debug.write(buf[0 .. (@intFromPtr(ptr) -% @intFromPtr(&buf)) +% 1]);
    }
    fn aboutDirFdNameModeDeviceNotice(about_s: fmt.AboutSrc, dir_fd: u64, name: [:0]const u8, file_mode: Mode, dev: Device) void {
        ...
        buf[0..about_s.len].* = about_s.*;
        var ptr: [*]u8 = buf[about_s.len..].ptr;
        ptr = ptr + writeDirFd(ptr, "dir_fd=", dir_fd);
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, name);
        ptr = ptr + name.len;
        ...
        ptr[0..6].* = ", dev=".*;
        ptr = ptr + 6;
        ptr = ptr + fmt.ud64(dev.major).formatWriteBuf(ptr);
        ptr[0] = ':';
        ptr = ptr + 1;
        ptr = ptr + fmt.ud64(dev.minor).formatWriteBuf(ptr);
        ptr[0] = '\n';
        debug.write(buf[0 .. (@intFromPtr(ptr) -% @intFromPtr(&buf)) +% 1]);
    }
    ...
    fn aboutDirFdNameDirFdNameNotice(about_s: fmt.AboutSrc, dir_fd1_s: []const u8, relation_s: [:0]const u8, dir_fd2_s: []const u8, dir_fd1: u64, name1: [:0]const u8, dir_fd2: u64, name2: [:0]const u8) void {
        ...
        buf[0..about_s.len].* = about_s.*;
        var ptr: [*]u8 = buf[about_s.len..].ptr;
        ptr = ptr + writeDirFd(ptr, dir_fd1_s, dir_fd1);
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, name1);
        ptr = ptr + name1.len;
        @memcpy(ptr, relation_s);
        ptr = ptr + relation_s.len;
        ptr = ptr + writeDirFd(ptr, dir_fd2_s, dir_fd2);
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, name2);
        ptr = ptr + name2.len;
    ...
    fn socketNotice(fd: u64, dom: Socket.Domain, conn: Socket.Connection) void {
        ...
        ptr = ptr + @tagName(dom).len;
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, @tagName(conn));
        ptr = ptr + @tagName(conn).len;
        ptr[0] = '\n';
    ...
    fn aboutPathnamePathnameNotice(about_s: fmt.AboutSrc, relation_s: [:0]const u8, pathname1: [:0]const u8, pathname2: [:0]const u8) void {
        ...
        ptr = ptr + pathname1.len;
        @memcpy(ptr, relation_s);
        ptr = ptr + relation_s.len;
        @memcpy(ptr, pathname2);
        ptr = ptr + pathname2.len;
        ptr[0] = '\n';
        debug.write(buf[0 .. (@intFromPtr(ptr) -% @intFromPtr(&buf)) +% 1]);
    }
    ...
    fn sendNotice(dest_fd: u64, src_fd: u64, offset: ?*u64, max_count: u64, act_count: u64) void {
        ...
        ud64.value = src_fd;
        if (offset) |off| {
            ptr = ptr + writeUpdateOffset(ptr, ud64, @bitCast(off.*));
        }
        debug.write(buf[0 .. @intFromPtr(ptr) -% @intFromPtr(&buf)]);
    }
    ...
    fn seekNotice(fd: u64, offset: u64, whence: Whence, to: u64) void {
        ...
        ptr[0..6].* = ", cur=".*;
        ptr = ptr + 6;
        ptr = ptr + fmt.ud64(to).formatWriteBuf(ptr);
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, @tagName(whence));
        ptr = ptr + @tagName(whence).len;
        ptr[0] = '+';
        ptr = ptr + 1;
        ptr = ptr + fmt.ud64(offset).formatWriteBuf(ptr);
        ptr[0] = '\n';
        debug.write(buf[0 .. (@intFromPtr(ptr) -% @intFromPtr(&buf)) +% 1]);
    }
    fn pollNotice(pollfds: []PollFd, timeout: u64) void {
        ...
        ptr[0..3].* = "fd=".*;
        ptr = ptr + 3;
        ptr = ptr + fmt.ud64(pollfds.len).formatWriteBuf(ptr);
        ptr[0..10].* = ", timeout=".*;
        ptr = ptr + 10;
        ptr = ptr + fmt.ud64(timeout).formatWriteBuf(ptr);
        ptr[0..3].* = "ms\n".*;
        ptr = ptr + 3;
        ptr = ptr + writePollFds(ptr, pollfds);
        debug.write(buf[0 .. @intFromPtr(ptr) -% @intFromPtr(&buf)]);
    }
    fn listenNotice(sock_fd: u64, backlog: u64) void {
        ...
        ptr[0..8].* = "sock_fd=".*;
        ptr = ptr + 8;
        ptr = ptr + fmt.ud64(sock_fd).formatWriteBuf(ptr);
        ptr[0..10].* = ", backlog=".*;
        ptr = ptr + 10;
        ptr = ptr + fmt.ud64(backlog).formatWriteBuf(ptr);
        ptr[0] = '\n';
        debug.write(buf[0 .. (@intFromPtr(ptr) -% @intFromPtr(&buf)) +% 1]);
    }
    pub fn executeNotice(pathname: [:0]const u8, args: []const [*:0]const u8) void {
        ...
        if (args.len != 0) {
            ptr[0] = ' ';
            ptr = ptr + 1;
            ptr = ptr + writeArgs(ptr, pathname, args);
        }
        ptr[0] = '\n';
        debug.write(buf[0 .. (@intFromPtr(ptr) -% @intFromPtr(&buf)) +% 1]);
    }
    ...
    fn socketError(socket_error: anytype, dom: Socket.Domain, conn: Socket.Connection) void {
        ...
        ptr = ptr + @errorName(socket_error).len;
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, @tagName(dom));
        ptr = ptr + @tagName(dom).len;
    ...
    fn sendError(sendfile_error: anytype, dest_fd: u64, src_fd: u64, offset: ?*u64, max_count: u64) void {
        ...
        ptr = ptr + @errorName(sendfile_error).len;
        ptr[0..9].* = ", src_fd=".*;
        ptr = ptr + 9;
        ptr = ptr + ud64.formatWriteBuf(ptr);
        ptr[0..10].* = ", dest_fd=".*;
        ...
        ptr = ptr + 7;
        if (offset) |off| {
            ptr = ptr + writeUpdateOffset(ptr, @bitCast(src_fd), @bitCast(off.*));
        }
        debug.write(buf[0 .. @intFromPtr(ptr) -% @intFromPtr(&buf)]);
    }
    fn copyError(copy_file_range_error: anytype, dest_fd: u64, dest_offset: ?*u64, src_fd: u64, src_offset: ?*u64, max_count: u64) void {
        ...
        ptr = ptr + @errorName(copy_file_range_error).len;
        ptr[0..9].* = ", src_fd=".*;
        ptr = ptr + 9;
        ptr = ptr + ud64.formatWriteBuf(ptr);
        ptr[0..10].* = ", dest_fd=".*;
        ...
        if (dest_offset) |off| {
            ptr = ptr + writeUpdateOffset(ptr, @bitCast(dest_fd), @bitCast(off.*));
        }
        debug.write(buf[0 .. @intFromPtr(ptr) -% @intFromPtr(&buf)]);
    }
    ...
    fn seekError(seek_error: anytype, fd: u64, offset: u64, whence: Whence) void {
        ...
        ptr = ptr + @errorName(seek_error).len;
        ptr[0..5].* = ", fd=".*;
        ptr = ptr + 5;
        ptr = ptr + fmt.ud64(fd).formatWriteBuf(ptr);
        ptr[0..5].* = ", to=".*;
    ...
    fn listenError(listen_error: anytype, sock_fd: u64, backlog: u64) void {
        ...
        ptr = ptr + @errorName(listen_error).len;
        ptr[0..10].* = ", sock_fd=".*;
        ptr = ptr + 10;
        ptr = ptr + fmt.ud64(sock_fd).formatWriteBuf(ptr);
        ptr[0..10].* = ", backlog=".*;
    ...
    pub fn executeErrorBrief(exec_error: anytype, pathname: [:0]const u8) void {
        ...
        ptr = ptr + execve_s.len;
        ptr[0..debug.about.error_s.len].* = debug.about.error_s.*;
        ptr = ptr + debug.about.error_s.len;
        @memcpy(ptr, @errorName(exec_error));
        ptr = ptr + @errorName(exec_error).len;
        ptr[0..2].* = ", ".*;
        ptr = ptr + 2;
        @memcpy(ptr, pathname);
        ptr = ptr + pathname.len;
    ...
    fn atDirFdMustBeFault(dir_fd: u64, name: [:0]const u8, kind: Kind, file_mode: Mode) void {
        ...
        var buf: [32768]u8 = undefined;
        var ptr: [*]u8 = &buf;
        ptr = ptr + fmt.ud64(dir_fd).formatWriteBuf(ptr);
    ...
    fn writeUpdateOffset(buf: [*]u8, fd: fmt.Type.Udsize, off: fmt.Type.Udsize) u64 {
        ...
        ptr[0..7].* = "offset=".*;
        ptr = ptr + 7;
        ptr = ptr + off.formatWriteBuf(ptr);
        ptr[0] = '\n';
    ...
    fn writeArgs(buf: [*]u8, pathname: [:0]const u8, args: []const [*:0]const u8) usize {
        ...
        if (idx != args.len) {
            ptr[0..9].* = " ... and ".*;
            ptr = ptr + 9;
            ptr = ptr + fmt.ud64(args.len -% idx).formatWriteBuf(ptr);
            ptr[0..16].* = " more args ... \n".*;
            ptr = ptr + 16;
        }
        return @intFromPtr(ptr) -% @intFromPtr(buf);
