...
pub const llvm_tblgen_command_attributes: types.Attributes = .{
    ...
    .params = &.{
        ...
        .{
            ...
            .string = "-d",
            .tag = .{ .optional_field = .repeatable_string },
            .type = .{ .store = &types.ProtoTypeDescr.init(?[]const []const u8) },
...
pub const llvm_llc_command_attributes: types.Attributes = .{
    ...
    .params = &.{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { generic = 0, apple = 1 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .string },
            .type = .{ .store = &types.ProtoTypeDescr.init(?[]const u8) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { table = 0, module = 1, kernel = 2, hybrid = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { always = 0, never = 1, arm = 2, thumb = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { @"force-disabled" = 0, @"force-enabled" = 1, allow = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { none = 0, global = 1 }) },
        },
        .{
            .name = "asan_debug",
            .string = "--asan-debug",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { never = 0, runtime = 1, always = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { all = 0, module = 1, cgscc = 2, none = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { Original = 0, AlwaysInline = 1, NeverInline = 2 }) },
        },
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { Line = 0, LineColumn = 1, LineDiscriminator = 2, LineColumnDiscriminator = 3 }) },
        },
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { Function = 0, Module = 1 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { tiny = 0, small = 1, kernel = 2, medium = 3, large = 4 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { throughput = 0, latency = 1, @"code-size" = 2, @"size-latency" = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { Disabled = 0, Arguments = 1, Structure = 2, Executions = 3, Details = 4 }) },
        },
        .{
            .name = "debugger_tune",
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { gdb = 0, lldb = 1, dbx = 2, sce = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { locations = 0, @"location+variables" = 1 }) },
        },
        .{
            .name = "debugify_quiet",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { ieee = 0, @"preserve-sign" = 1, @"positive-zero" = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, pgo = 1, all = 2 }) },
        },
        .{
            .name = "disable_hsdr",
            .string = "--disable-hsdr",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { Default = 0, Enable = 1, Disable = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { Default = 0, All = 1, Abstract = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { always = 0, @"no-compact-unwind" = 1, default = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { always = 0, never = 1 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { default = 0, development = 1, release = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { default = 0, dwarf = 1, sjlj = 2, arm = 3, wineh = 4, wasm = 5 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { @"asm" = 0, obj = 1, null = 2 }) },
        },
        .{
            .name = "filter_passes",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { default = 0, soft = 1, hard = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, @"all-non-critical" = 1, all = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { fast = 0, on = 1, off = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { all = 0, @"non-leaf" = 1, none = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { @"0" = 0, @"1" = 1, @"2" = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, instr = 1, libcall = 2 }) },
        },
        .{
            .name = "hwasan_recover",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { size = 0, cost = 1, @"cost-benefit" = 2, ml = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { basic = 0, verbose = 1 }) },
        },
        .{
            .name = "insert_all0",
            .string = "--insert-all0",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { scev = 0, da = 1, all = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, import = 1, @"export" = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, preindexed = 1, postindexed = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, optimized = 1, @"post-merge-pre-opt" = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { @"column-major" = 0, @"row-major" = 1 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { default = 0, @"4" = 1, @"5" = 2, gnu = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u4) { v60 = 0, v62 = 1, v65 = 2, v66 = 3, v67 = 4, v68 = 5, v69 = 6, v71 = 7, v73 = 8 }) },
        },
        .{
            .name = "mhvx_ieee_fp",
            .string = "--mhvx-ieee-fp",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, @"16bit" = 1, @"32bit" = 2, f5series = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { Default = 0, Ranges = 1, Expressions = 2, Form = 3, Disabled = 4 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { never = 0, optimal = 1, always = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u4) { default = 0, converge = 1, ilpmax = 2, ilpmin = 3, si = 4, @"gcn-max-occupancy" = 5, @"gcn-max-ilp" = 6, @"gcn-iterative-max-occupancy-experimental" = 7, @"gcn-iterative-minreg" = 8, @"gcn-iterative-ilp" = 9, r600 = 10, hexagon = 11, @"ppc-prera" = 12, @"ppc-postra" = 13 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, graph = 1, text = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u4) { none = 0, all = 1, i32 = 2, i64 = 3, nonextin = 4, zext = 5, zexti32 = 6, zexti64 = 7, sext = 8, sexti32 = 9, sexti64 = 10 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { @"vliw-td" = 0, @"list-ilp" = 1, @"list-hybrid" = 2, source = 3, @"list-burr" = 4, linearize = 5, fast = 6, default = 7 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { @"scalar-epilogue" = 0, @"predicate-else-scalar-epilogue" = 1, @"predicate-dont-vectorize" = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { quiet = 0, diff = 1, @"diff-quiet" = 2, cdiff = 3, @"cdiff-quiet" = 4, @"dot-cfg" = 5, @"dot-cfg-quiet" = 6 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, bb = 1, rn = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { pbqp = 0, greedy = 1, fast = 2, basic = 3, default = 4 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { default = 0, release = 1, development = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { static = 0, pic = 1, @"dynamic-no-pic" = 2, ropi = 3, rwpi = 4, @"ropi-rwpi" = 5 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { never = 0, cheap = 1, unusedindvarinloop = 2, noharduse = 3, always = 4 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { off = 0, preferred = 1, on = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { default = 0, basic = 1, greedy = 2, fast = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { default = 0, size = 1, speed = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { never = 0, safe = 1, always = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { auto = 0, always = 1, never = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { disabled = 0, @"enabled-no-reductions" = 1, enabled = 2, @"force-enabled-no-reductions" = 3, @"force-enabled" = 4 }) },
        },
        .{
            .name = "tailcallopt",
            .string = "--tailcallopt",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { posix = 0, single = 1 }) },
        },
        .{
            .name = "threads",
            .string = "--threads",
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u3) { none = 0, Accelerate = 1, Darwin_libsystem_m = 2, @"LIBMVEC-X86" = 3, MASSV = 4, SVML = 5, sleefgnuabi = 6 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { basic = 0, greedy = 1, fast = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, fraction = 1, integer = 2, count = 3 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u2) { none = 0, trap = 1, fallback = 2 }) },
        },
        .{
        ...
        .{
            ...
            .tag = .{ .optional_field = .tag },
            .type = .{ .store = &types.ProtoTypeDescr.init(?enum(u1) { att = 0, intel = 1 }) },
        },
        .{
