...
const source = types.GenericExtraCommand(types.BuildCommand);
renderWriteBuf: *const fn (
    p_0: *const types.BuildCommand,
    p_1: [*]u8,
) usize = @ptrFromInt(8),
fieldEditDistance: *const fn (
    p_0: *types.BuildCommand,
    p_1: *types.BuildCommand,
) usize = @ptrFromInt(8),
writeFieldEditDistance: *const fn (
    p_0: [*]u8,
    p_1: []const u8,
    p_2: *types.BuildCommand,
    p_3: *types.BuildCommand,
    p_4: bool,
) usize = @ptrFromInt(8),
